...
namespace openapi_tests.Data
{
    ...
    public class ChildCardStatsPostCard
    {
    ...
    public class DatumPostCard
    {
        ...
        public ReporterPostCard reporter { get; set; }
        ...
        public ChildCardStatsPostCard child_card_stats { get; set; }
        ...
        public List<object> column_checklist_items { get; set; }
